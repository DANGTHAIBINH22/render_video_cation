...
const { OUTPUT_DIR, INPUTS, ffmpegPath, execCmd, ensureOutputDir, normalizePathForCli, relativePathForCli } = require('./video_utils');
...
async function run() {
  ...
  const args = [
    ...
    '-i', normalizePathForCli(relativePathForCli(INPUTS.audio)),
    '-map', '0:v:0',
    '-map', '1:a:0',
    '-c:v', 'copy',
    '-c:a', 'aac', '-b:a', '192k',
